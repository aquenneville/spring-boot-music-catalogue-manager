...
public class ArtistParser {
	...
	public List<Artist> parseMusicbrainzArtists(String jsonContent) throws IOException {
		...
		while (elements.hasNext()) {
			 ...
			 if (apiId.length() > 0 && apiArtistName.length() > 0 && "100".equals(apiScore)) {
				 ...
				 Artist musicBrainzArtist = new Artist();
				 //musicBrainzArtist.setApiId(apiIdentifier);
